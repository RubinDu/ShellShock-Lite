...
#
# Script generated by Vivado on Mon Nov 20 15:04:31 -0600 2023
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/fpga_workspace/project_final/project_final/project_final.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
